...
#ifndef VRX_RANDOM_LIGHT_BUOY_PLUGIN_HH_
#define VRX_RANDOM_LIGHT_BUOY_PLUGIN_HH_
...
namespace vrx
{
  ...
  ///     </visuals>
  ///   </plugin>
  class RandomLightBuoyPlugin
    : public gz::sim::System,
      public gz::sim::ISystemConfigure,
      public gz::sim::ISystemPreUpdate
  {
    /// \brief Constructor
    public: RandomLightBuoyPlugin();

    /// \brief Destructor.
    public: ~RandomLightBuoyPlugin() override = default;
